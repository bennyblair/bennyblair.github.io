    ...
    <div className="min-h-screen bg-slate-950 text-slate-100">
      ...
      <div className="container mx-auto px-4 py-8">
        ...
        <section className="max-w-5xl mx-auto text-center pt-4 pb-12">
          <Badge className="mb-4 bg-sky-500/15 text-sky-300 border border-sky-500/30">{city} Asset Backed Finance</Badge>
          <div className="flex items-center justify-center gap-3 mb-4">
            <MapPin className="h-8 w-8 text-sky-300" />
            <h1 className="text-4xl lg:text-5xl font-bold text-white">Asset Backed Lending {city}</h1>
          </div>
        ...
        <section className="max-w-5xl mx-auto grid lg:grid-cols-2 gap-6 mb-12">
          <div className="bg-slate-900 border border-slate-800 rounded-xl p-8">
            <h2 className="text-2xl font-bold text-white mb-4">How asset backed lending may fit {city} businesses</h2>
            <p className="text-slate-300 leading-relaxed mb-4">{description}</p>
            <p className="text-slate-300 leading-relaxed">{localFocus}</p>
          </div>
          <div className="bg-slate-900 border border-slate-800 rounded-xl p-8">
            <h2 className="text-2xl font-bold text-white mb-4">Why timing and security structure matter in {city}</h2>
            <p className="text-slate-300 leading-relaxed mb-4">{timingPressures}</p>
            <div className="space-y-4 text-slate-300">
              <p><span className="font-semibold text-white">Security mix:</span> the strongest structures usually line up the right asset class with the right lender rather than trying to make every asset do the same job.</p>
              <p><span className="font-semibold text-white">Advance rates:</span> property, equipment, inventory, and receivables all attract different leverage expectations and monitoring requirements.</p>
              <p><span className="font-semibold text-white">Commercial purpose:</span> lenders still want a clear use of funds, whether that is working capital, growth, refinancing pressure, or a short-term opportunity.</p>
              <p><span className="font-semibold text-white">Exit and control:</span> the cleaner the repayment path and reporting discipline, the easier it is to keep the facility working for the business rather than against it.</p>
            </div>
          </div>
        </section>
        ...
        <section className="max-w-5xl mx-auto mb-12">
          <div className="bg-slate-900 border border-slate-800 rounded-xl p-8">
            <h2 className="text-3xl font-bold text-white mb-8 text-center">Common security types in {city}</h2>
        ...
        <section className="max-w-5xl mx-auto mb-12">
          <h2 className="text-3xl font-bold text-white mb-8 text-center">Common {city} asset backed lending use cases</h2>
          <div className="grid md:grid-cols-2 gap-6">
        ...
        <section className="max-w-4xl mx-auto text-center pb-12">
          <div className="bg-slate-900 border border-slate-800 rounded-xl p-8 mb-6">
            <h2 className="text-3xl font-bold text-white mb-4">Need an asset backed lending solution in {city}?</h2>
