      ...
      <div className="container mx-auto px-4 py-8">
        ...
        <section className="max-w-5xl mx-auto grid lg:grid-cols-2 gap-6 mb-12">
          <div className="bg-slate-900 border border-slate-800 rounded-xl p-8">
            <h2 className="text-2xl font-bold text-white mb-4">How private lending may fit {city} deals</h2>
          ...
          <div className="bg-slate-900 border border-slate-800 rounded-xl p-8">
            ...
            <div className="space-y-4 text-slate-300">
              <p><span className="font-semibold text-white">Security quality:</span> property type, title position, existing debt, and marketability still drive lender appetite.</p>
              <p><span className="font-semibold text-white">Commercial purpose:</span> private lenders still want to know exactly why the funds are needed and what they are enabling.</p>
              <p><span className="font-semibold text-white">Exit strategy:</span> sale, refinance, project milestone, or another defined repayment event needs to be believable.</p>
              <p><span className="font-semibold text-white">Execution readiness:</span> in private credit, the deals that settle fastest are usually the deals prepared best.</p>
            </div>
          </div>
        </section>
        ...
        <section className="max-w-5xl mx-auto mb-12">
          <h2 className="text-3xl font-bold text-white mb-8 text-center">Common {city} private lending use cases</h2>
        ...
        <section className="max-w-4xl mx-auto text-center pb-12">
          <div className="bg-slate-900 border border-slate-800 rounded-xl p-8 mb-6">
            <h2 className="text-3xl font-bold text-white mb-4">Need a {city} private lending solution?</h2>
