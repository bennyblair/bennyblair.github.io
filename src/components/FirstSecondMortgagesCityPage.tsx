...
const stats = [
  ...
  { label: 'Typical leverage', value: 'Up to 75%', icon: TrendingUp },
  { label: 'Common term', value: '1-30 years', icon: CheckCircle },
  ...
  return (
    <div className="min-h-screen bg-slate-950 text-slate-100">
      <SEO
        ...
        canonical={canonical}
        keywords={`second mortgage ${city}, first mortgage ${city}, commercial mortgage ${city}, business property finance ${city}`}
        schemas={[generateServiceSchema(`1st & 2nd Mortgages ${city}`, description, `https://emetcapital.com.au${canonical}`)]}
      />
