        ...
        <div className="text-center max-w-4xl mx-auto mb-16">
          ...
          <div className="max-w-4xl mx-auto space-y-12 mb-16">
            ...
            <section className="mb-12">
                ...
                >
                  <div className="flex items-start gap-4">
                    ...
                    <div>
                      ...
                      <p className="text-muted-foreground mb-3">Comprehensive working capital guide covering trade finance as part of overall business funding strategy.</p>
              ...
              <a 
                href="/resources/guides/trade-finance-in-australia-how-it-helps-businesses-manage-imports"
                className="block p-4 border border-border rounded-lg hover:border-accent/40 hover:bg-accent/5 transition-all"
              >
                <h3 className="font-semibold text-foreground mb-2">Trade Finance Guide</h3>
                <p className="text-sm text-muted-foreground mb-2">Managing imports, exports, and international trade with trade finance facilities.</p>
              ...
              >
                ...
                <p className="text-sm text-muted-foreground mb-2">Fund export receivables and import stock through invoice finance.</p>
                <span className="text-accent text-sm inline-flex items-center">
                  Read Guide <ArrowRight className="ml-1 h-3 w-3" />
                </span>
              </a>
              ...
              >
                ...
                <p className="text-sm text-muted-foreground mb-2">Supply chain funding to manage international supplier payments.</p>
                <span className="text-accent text-sm inline-flex items-center">
                  Read Guide <ArrowRight className="ml-1 h-3 w-3" />
                </span>
              </a>
          ...
          <DiscoveryGuides service="trade-finance" />
