...
const PrivateLending = () => {
  ...
  return (
    <>
      <Helmet>
        <title>Private Lending Australia | Emet Capital</title>
        <meta 
          name="description" 
        ...
        <div className="container mx-auto px-4">
          ...
          <div className="max-w-4xl mx-auto space-y-12 mb-16">
            ...
            <section className="mb-12">
              ...
              <div className="md:col-span-2 lg:col-span-3">
                ...
                >
                  <div className="flex items-start gap-4">
                    ...
                    <div>
                      <h3 className="text-xl font-semibold text-foreground mb-2">What is Private Lending?</h3>
                      <p className="text-muted-foreground mb-3">Complete guide to private lending in Australia—how it works, costs, risks, and when it's the right choice.</p>
              ...
              <a 
                ...
                className="block p-4 border border-border rounded-lg hover:border-accent/40 hover:bg-accent/5 transition-all"
              >
                <h3 className="font-semibold text-foreground mb-2">Comparing Private Lenders 2025</h3>
                <p className="text-sm text-muted-foreground mb-2">Current market comparison of private lending rates and terms.</p>
                <span className="text-accent text-sm inline-flex items-center">
                  Read Guide <ArrowRight className="ml-1 h-3 w-3" />
                </span>
              </a>
              ...
              >
                ...
                <p className="text-sm text-muted-foreground mb-2">Specialist lenders for commercial real estate outside bank criteria.</p>
                <span className="text-accent text-sm inline-flex items-center">
                  Read Guide <ArrowRight className="ml-1 h-3 w-3" />
                </span>
              </a>
          ...
          <section className="mb-16">
            <div className="bg-muted/30 rounded-lg p-8">
              <h2 className="text-2xl font-bold text-foreground mb-4">Private Lending by Location</h2>
              <p className="text-muted-foreground mb-6">
                Explore our city-specific private lending pages for local market context and non-bank funding scenarios:
              </p>
              <div className="flex flex-wrap gap-3">
                <Link to="/services/private-lending/cities/sydney" className="inline-flex items-center px-4 py-2 bg-accent/10 hover:bg-accent/20 text-accent rounded-lg transition-colors">Sydney <ArrowRight className="ml-2 h-4 w-4" /></Link>
              </div>
            </div>
          </section>
        </div>
