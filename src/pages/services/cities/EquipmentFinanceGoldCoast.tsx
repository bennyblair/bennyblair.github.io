...
export default function EquipmentFinanceGoldCoast() {
  return (
    <EquipmentFinanceCityPage
      city="Gold Coast"
      state="QLD"
      canonical="/services/equipment-finance/cities/gold-coast"
      title="Equipment Finance Gold Coast | Emet Capital"
      description="Equipment finance in Gold Coast for businesses funding vehicles, machinery, and specialist commercial assets where lender fit, timing, and structure all matter."
      localIntro="Equipment finance for Gold Coast businesses that need a commercial structure aligned to the transaction rather than a generic lending template."
      localFocus="Gold Coast equipment finance files often involve service-led and growth-oriented commercial market across healthcare, hospitality, trades, professional services, and logistics where commercial timing, supporting information, and lender fit can materially affect the outcome."
      ...
      suburbCoverage={[
        { title: 'CBD and central commercial precincts', text: 'Gold Coast CBD and nearby business districts often generate equipment finance scenarios for established commercial borrowers.' },
