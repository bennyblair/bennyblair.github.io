...
export default function EquipmentFinancePerth() {
  return (
    <EquipmentFinanceCityPage
      city="Perth"
      state="WA"
      canonical="/services/equipment-finance/cities/perth"
      title="Equipment Finance Perth | Emet Capital"
      description="Equipment finance in Perth for businesses funding vehicles, machinery, and specialist commercial assets where lender fit, timing, and structure all matter."
      localIntro="Equipment finance for Perth businesses that need a commercial structure aligned to the transaction rather than a generic lending template."
      localFocus="Perth equipment finance files often involve resource-linked commercial market across trade, industrial, logistics, healthcare, and service operators where commercial timing, supporting information, and lender fit can materially affect the outcome."
      ...
      suburbCoverage={[
        { title: 'CBD and central commercial precincts', text: 'Perth CBD and nearby business districts often generate equipment finance scenarios for established commercial borrowers.' },
