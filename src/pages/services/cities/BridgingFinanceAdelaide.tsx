                  ...
                  <div className="bg-white p-6 rounded-lg">
                    ...
                    <div className="space-y-3 text-sm">
                      ...
                      <div className="flex justify-between pt-3 border-t">
                        ...
                        <span className="font-semibold text-accent">$250K cash remaining</span>
                      </div>
                    </div>
                  </div>
                </div>
                  ...
                  <div className="bg-white p-6 rounded-lg">
                    ...
                    <div className="space-y-3 text-sm">
                      ...
                      <div className="flex justify-between pt-3 border-t">
                        ...
                        <span className="font-semibold text-accent">$480K (17% margin)</span>
                      </div>
                    </div>
                  </div>
                </div>
                  ...
                  <div className="bg-white p-6 rounded-lg">
                    ...
                    <div className="space-y-3 text-sm">
                      ...
                      <div className="flex justify-between pt-3 border-t">
                        ...
                        <span className="font-semibold text-accent">Hills lifestyle secured</span>
                      </div>
                    </div>
                  </div>
                </div>
