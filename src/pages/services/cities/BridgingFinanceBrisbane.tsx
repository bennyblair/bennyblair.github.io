                  ...
                  <div className="bg-background p-6 rounded-lg border shadow-sm">
                    ...
                    <div className="space-y-3 text-sm">
                      ...
                      <div className="flex justify-between pt-3 border-t">
                        ...
                        <span className="font-semibold text-accent">$700K cash remaining</span>
                      </div>
                    </div>
                  </div>
                </div>
                  ...
                  <div className="bg-background p-6 rounded-lg border shadow-sm">
                    ...
                    <div className="space-y-3 text-sm">
                      ...
                      <div className="flex justify-between pt-3 border-t">
                        ...
                        <span className="font-semibold text-accent">$2.8M (19% margin)</span>
                      </div>
                    </div>
                  </div>
                </div>
                  ...
                  <div className="bg-background p-6 rounded-lg border shadow-sm">
                    ...
                    <div className="space-y-3 text-sm">
                      ...
                      <div className="flex justify-between pt-3 border-t">
                        ...
                        <span className="font-semibold text-accent">Upgraded lifestyle secured</span>
                      </div>
                    </div>
                  </div>
                </div>
