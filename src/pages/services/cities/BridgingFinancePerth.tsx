    ...
    <div className="min-h-screen bg-background">
      <SEO 
        ...
        schemas={[generateServiceSchema(
          ...
          "Fast bridging loans in Perth WA. 24-48 hour approvals for property purchases, auctions, and time-sensitive opportunities. Local expertise, competitive rates.",
          "https://emetcapital.com.au/bridging-finance-perth"
        )]}
      />
      {/* Hero Section */}
                  ...
                  <div className="bg-background p-6 rounded-lg border shadow-sm">
                    ...
                    <div className="space-y-3 text-sm">
                      ...
                      <div className="flex justify-between pt-3 border-t">
                        ...
                        <span className="font-semibold text-accent">Secured coastal lifestyle</span>
                      </div>
                    </div>
                  </div>
                </div>
                  ...
                  <div className="bg-background p-6 rounded-lg border shadow-sm">
                    ...
                    <div className="space-y-3 text-sm">
                      ...
                      <div className="flex justify-between pt-3 border-t">
                        ...
                        <span className="font-semibold text-accent">$420K (20% margin)</span>
                      </div>
                    </div>
                  </div>
                </div>
                  ...
                  <div className="bg-background p-6 rounded-lg border shadow-sm">
                    ...
                    <div className="space-y-3 text-sm">
                      ...
                      <div className="flex justify-between">
                        ...
                        <span className="font-semibold text-accent">$43,400 (7%)</span>
                      </div>
                      <div className="flex justify-between pt-3 border-t">
                        <span className="text-gray-600 font-semibold">Net Position:</span>
                        <span className="font-semibold text-accent">Strong yield + growth</span>
                      </div>
                    </div>
                  </div>
                </div>
