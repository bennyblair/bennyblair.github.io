...
export default function CaveatLoansMelbourne() {
  return (
    <CaveatLoansCityPage
      ...
      timingPressures="In Melbourne, caveat loans usually appear when a maturing facility is too close, a settlement cannot wait, or a commercial problem such as tax debt or urgent working-capital pressure needs to be stabilised before a longer-term solution is ready. Fast assessment still depends on a current title search, mortgage payout, entity and identity documents, a clear business purpose, usable equity and a dated exit."
      suburbCoverage={[
      ...
      scenarios={[
        { title: 'Illustrative: Dandenong South maturity gap', scenario: 'Illustrative scenario only: a business owner with an industrial property in Dandenong South needs to repay a maturing lender before replacement debt has completed credit and legal review.', solution: 'A caveat facility could create a short-term bridge so the borrower has time to complete the refinance without immediate forced-sale pressure.', outcomes: [
        ...
        { title: 'Illustrative: ATO debt backed by investment property', scenario: 'Illustrative scenario only: a Melbourne business owner needs urgent capital to address tax pressure while arranging a broader debt restructure using available investment-property equity.', solution: 'A short-term caveat loan may address the immediate deadline and create time for a more orderly medium-term solution, provided the wider restructure is credible.', outcomes: [
        ...
        { title: 'Illustrative: Collingwood acquisition timing', scenario: 'Illustrative scenario only: an investor needs urgent short-term capital against an existing property to preserve a new commercial acquisition with a tight settlement.', solution: 'Caveat-backed funding may create enough time to settle first and complete a longer-form permanent debt process afterward.', outcomes: [
      ...
      faqs={[
        ...
        { question: 'What should be ready before requesting urgent caveat finance?', answer: 'Prepare the current title and mortgage statement, requested amount, business-purpose use of funds, entity and identity documents, any deadline evidence, and a specific repayment or refinance path. Missing payout, ownership or exit details can prevent a fast assessment.' },
