...
export default function FirstSecondMortgagesSydney() {
  return (
    <FirstSecondMortgagesCityPage
      ...
      title="Second Mortgage Sydney & Commercial First Mortgages | Emet Capital"
      description="Sydney second mortgage and commercial first mortgage solutions for business borrowers using property equity for acquisitions, refinance pressure, equity release, and time-sensitive transactions."
      localIntro="Sydney second mortgage and commercial first mortgage options for borrowers dealing with premium asset values, faster contract pressure, and lender scrutiny that tends to intensify as deal size and complexity increases across the metro market."
