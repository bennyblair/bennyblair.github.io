      ...
      <div className="min-h-screen py-8">
        <div className="container mx-auto px-4 max-w-4xl">
          ...
          <article className="prose prose-lg max-w-none">
            <h1>1st and 2nd Mortgages in Sydney</h1>
            ...
            <h2>Why 1st and 2nd Mortgages Matter in Sydney</h2>
            ...
            <ul>
              <li><strong>Property Developers</strong> acquiring sites, funding construction phases, or bridging between project stages across Sydney's suburbs and metro areas</li>
              <li><strong>Business Owners</strong> purchasing owner-occupied premises, consolidating business debt against property equity, or funding fit-outs and refurbishments</li>
              <li><strong>Property Investors</strong> building commercial portfolios, undertaking value-add renovations, or refinancing to release capital for additional acquisitions</li>
              <li><strong>SME Directors</strong> accessing working capital secured against commercial property without disrupting existing banking relationships</li>
              <li><strong>Companies in Transition</strong> requiring fast settlement funding while restructuring or awaiting alternative finance approval</li>
            </ul>

            <h2>How 1st and 2nd Mortgages Work</h2>
            ...
            <ol>
              <li><strong>Initial Assessment</strong> - Contact our team to discuss your property, funding requirements, and timeframe. We'll assess your scenario and recommend whether a first or second mortgage (or both) best suits your needs.</li>
              <li><strong>Property Valuation</strong> - An independent valuation establishes current market value and determines available lending capacity. Sydney's transparent property market typically enables fast valuation turnaround.</li>
              <li><strong>Lender Matching</strong> - We present your application to our network of commercial and private lenders, securing competitive terms based on LVR, property type, and loan purpose.</li>
              <li><strong>Documentation & Approval</strong> - Submit standard business and property documentation. For straightforward applications with clear equity positions, approval can occur within 24-48 hours.</li>
              <li><strong>Settlement</strong> - Once approved, legal processes proceed to settlement, with funds typically available within 1-2 weeks for first mortgages, or faster for second mortgage top-ups where existing arrangements remain in place.</li>
            </ol>

            <h2>Benefits vs Going Direct to a Bank</h2>
            ...
            <ul>
              <li><strong>Speed of Approval</strong> - Specialist lenders can assess and approve applications in days rather than the weeks or months typical of major bank credit committees</li>
              <li><strong>Non-Bank Access</strong> - We connect you with private and specialist lenders who assess deals on commercial merit and security value, not just credit scoring and trading history</li>
              <li><strong>Flexible Credit Assessment</strong> - Past credit events, business transitions, or non-standard income structures don't automatically disqualify applications as they might with banks</li>
              <li><strong>Real Assessment Focus</strong> - Lending decisions prioritize property value, equity position, and clear exit strategy over rigid serviceability formulas</li>
              <li><strong>Second Mortgage Specialists</strong> - Banks rarely offer second mortgage products; our lender network includes specialists comfortable with subordinated security positions</li>
              <li><strong>Local Market Knowledge</strong> - Sydney-experienced brokers understand property types, locations, and value drivers that support strong lending propositions</li>
            </ul>

            <h2>Real Sydney Example</h2>
            ...
            <div className="bg-accent/10 border border-accent/20 rounded-lg p-8 my-8">
              <h3 className="text-2xl font-bold mb-4">Apply Now for 1st and 2nd Mortgages in Sydney</h3>
              <p className="mb-6">
