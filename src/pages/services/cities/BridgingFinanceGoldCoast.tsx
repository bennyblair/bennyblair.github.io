                  ...
                  <div className="bg-background p-6 rounded-lg border shadow-sm">
                    ...
                    <div className="space-y-3 text-sm">
                      ...
                      <div className="flex justify-between pt-3 border-t">
                        ...
                        <span className="font-semibold text-accent">$500K cash remaining</span>
                      </div>
                    </div>
                  </div>
                </div>
                  ...
                  <div className="bg-background p-6 rounded-lg border shadow-sm">
                    ...
                    <div className="space-y-3 text-sm">
                      ...
                      <div className="flex justify-between pt-3 border-t">
                        ...
                        <span className="font-semibold text-accent">$920K (17% margin)</span>
                      </div>
                    </div>
                  </div>
                </div>
                  ...
                  <div className="bg-background p-6 rounded-lg border shadow-sm">
                    ...
                    <div className="space-y-3 text-sm">
                      ...
                      <div className="flex justify-between">
                        ...
                        <span className="font-semibold text-accent">$60,000 (8%)</span>
                      </div>
                      <div className="flex justify-between pt-3 border-t">
