...
export default function BusinessAcquisitionAdelaide() {
  return (
    <BusinessAcquisitionCityPage
      city="Adelaide"
      state="SA"
      canonical="/services/business-acquisition/cities/adelaide"
      title="Business Acquisition Finance Adelaide | Emet Capital"
      description="Business acquisition finance in Adelaide for buyers purchasing established businesses, practices, and commercial operations where lender fit, timing, and structure all matter."
      localIntro="Business acquisition finance for Adelaide businesses that need a commercial structure aligned to the transaction rather than a generic lending template."
      localFocus="Adelaide business acquisition finance files often involve mid-market commercial environment across manufacturing, healthcare, trade, services, and family businesses where commercial timing, supporting information, and lender fit can materially affect the outcome."
      ...
      suburbCoverage={[
        { title: 'CBD and central commercial precincts', text: 'Adelaide CBD and nearby business districts often generate business acquisition finance scenarios for established commercial borrowers.' },
