...
export default function BusinessAcquisitionPerth() {
  return (
    <BusinessAcquisitionCityPage
      city="Perth"
      state="WA"
      canonical="/services/business-acquisition/cities/perth"
      title="Business Acquisition Finance Perth | Emet Capital"
      description="Business acquisition finance in Perth for buyers purchasing established businesses, practices, and commercial operations where lender fit, timing, and structure all matter."
      localIntro="Business acquisition finance for Perth businesses that need a commercial structure aligned to the transaction rather than a generic lending template."
      localFocus="Perth business acquisition finance files often involve resource-linked commercial market across trade, industrial, logistics, healthcare, and service operators where commercial timing, supporting information, and lender fit can materially affect the outcome."
      ...
      suburbCoverage={[
        { title: 'CBD and central commercial precincts', text: 'Perth CBD and nearby business districts often generate business acquisition finance scenarios for established commercial borrowers.' },
