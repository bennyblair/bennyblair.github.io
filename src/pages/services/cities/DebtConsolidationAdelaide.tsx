...
export default function DebtConsolidationAdelaide() {
  return (
    <DebtConsolidationCityPage
      city="Adelaide"
      state="SA"
      canonical="/services/debt-consolidation/cities/adelaide"
      title="Business Debt Consolidation Adelaide | Emet Capital"
      description="Business debt consolidation in Adelaide for companies combining multiple facilities into a cleaner refinance structure where lender fit, timing, and structure all matter."
      localIntro="Business debt consolidation for Adelaide businesses that need a commercial structure aligned to the transaction rather than a generic lending template."
      localFocus="Adelaide business debt consolidation files often involve mid-market commercial environment across manufacturing, healthcare, trade, services, and family businesses where commercial timing, supporting information, and lender fit can materially affect the outcome."
      ...
      suburbCoverage={[
        { title: 'CBD and central commercial precincts', text: 'Adelaide CBD and nearby business districts often generate business debt consolidation scenarios for established commercial borrowers.' },
