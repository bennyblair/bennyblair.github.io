    ...
    <div className="min-h-screen py-8 bg-background">
      <SEO 
        ...
        schemas={[generateServiceSchema(
          ...
          "https://emetcapital.com.au/services/bridging-finance/cities/sydney"
        )]}
      />
      <div className="container mx-auto px-4">
        ...
        <section className="text-center max-w-5xl mx-auto mb-16">
          ...
          <div className="flex items-center justify-center gap-3 mb-4">
            ...
            <h1 className="text-4xl lg:text-5xl font-bold">Bridging Finance Sydney</h1>
          </div>
          <p className="text-xl text-muted-foreground mb-8 max-w-4xl mx-auto">
            Fast bridging loans for Sydney property transactions, development opportunities, auctions, and time-sensitive commercial scenarios across Greater Sydney.
          </p>
          <div className="grid grid-cols-2 md:grid-cols-4 gap-4 max-w-4xl mx-auto mb-8">
            <div className="bg-muted/40 p-4 rounded-lg border">
              <div className="text-2xl font-bold mb-1">24-48hrs</div>
              <div className="text-foreground/70 text-sm">Approval Time</div>
            </div>
            <div className="bg-muted/40 p-4 rounded-lg border">
              <div className="text-2xl font-bold mb-1">Up to 80%</div>
              <div className="text-foreground/70 text-sm">LVR Available</div>
            </div>
            <div className="bg-muted/40 p-4 rounded-lg border">
              <div className="text-2xl font-bold mb-1">1-24 months</div>
              <div className="text-foreground/70 text-sm">Flexible Terms</div>
            </div>
            <div className="bg-muted/40 p-4 rounded-lg border">
              <div className="text-2xl font-bold mb-1">$100K-$20M</div>
              <div className="text-foreground/70 text-sm">Loan Range</div>
            </div>
          </div>
          ...
          <div className="max-w-4xl mx-auto">
            ...
            <div className="grid md:grid-cols-2 gap-8 mb-12">
              ...
              <div>
                ...
                <ul className="space-y-3">
                  <li className="flex items-start">
                    <Building2 className="text-accent mr-3 flex-shrink-0 mt-1" size={20} />
                  ...
                  <div className="bg-background p-6 rounded-lg">
                    ...
                    <div className="space-y-3 text-sm">
                      <div className="flex justify-between">
                        <span className="text-foreground/70">New Property Value:</span>
                        <span className="font-semibold">$3,200,000</span>
                      </div>
                      <div className="flex justify-between">
                        <span className="text-foreground/70">Bridging Loan:</span>
                        <span className="font-semibold">$1,800,000</span>
                      </div>
                      <div className="flex justify-between">
                        <span className="text-foreground/70">Bridge Term:</span>
                        <span className="font-semibold">6 months (actual)</span>
                      </div>
                      <div className="flex justify-between">
                        <span className="text-foreground/70">Interest Cost:</span>
                ...
                <div className="grid md:grid-cols-2 gap-6">
                  ...
                  <div className="bg-background p-6 rounded-lg">
                    ...
                    <div className="space-y-3 text-sm">
                      ...
                      <div className="flex justify-between">
                        <span className="text-foreground/70">Bridging Term:</span>
                        <span className="font-semibold">10 months (actual)</span>
                      </div>
                      <div className="flex justify-between">
                        <span className="text-foreground/70">Interest + Fees:</span>
                        <span className="font-semibold">$412,000</span>
                      </div>
                      <div className="flex justify-between">
                        <span className="text-foreground/70">Project GRV:</span>
                ...
                <div className="grid md:grid-cols-2 gap-6">
                  ...
                  <div className="bg-background p-6 rounded-lg">
                    ...
                    <div className="space-y-3 text-sm">
                      ...
                      <div className="flex justify-between">
                        <span className="text-foreground/70">Market Value (auction est.):</span>
        ...
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto">
            ...
            <div className="space-y-6">
              <div className="bg-background p-6 rounded-lg shadow-sm">
                <h3 className="text-xl font-semibold mb-3 text-foreground">Can I get bridging finance for a Sydney auction purchase?</h3>
                <p className="text-foreground/80">
              ...
              <div className="bg-background p-6 rounded-lg shadow-sm">
                <h3 className="text-xl font-semibold mb-3 text-foreground">What LVR can I get for Eastern Suburbs properties?</h3>
                <p className="text-foreground/80">
              ...
              <div className="bg-background p-6 rounded-lg shadow-sm">
                <h3 className="text-xl font-semibold mb-3 text-foreground">How quickly can you settle for a Parramatta development site?</h3>
                <p className="text-foreground/80">
              ...
              <div className="bg-background p-6 rounded-lg shadow-sm">
                <h3 className="text-xl font-semibold mb-3 text-foreground">Do you bridge for properties over $5 million in Sydney?</h3>
                <p className="text-foreground/80">
              ...
              <div className="bg-background p-6 rounded-lg shadow-sm">
                <h3 className="text-xl font-semibold mb-3 text-foreground">What if my existing Sydney property hasn't sold within the bridge term?</h3>
                <p className="text-foreground/80">
              ...
              <div className="bg-background p-6 rounded-lg shadow-sm">
                <h3 className="text-xl font-semibold mb-3 text-foreground">Can you help with bridging finance for SMSF property purchases in Sydney?</h3>
                <p className="text-foreground/80">
