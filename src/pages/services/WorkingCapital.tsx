        ...
        <div className="container mx-auto px-4">
          ...
          <div className="max-w-4xl mx-auto space-y-12 mb-16">
            ...
            <section className="mb-12">
                ...
                >
                  <div className="flex items-start gap-4">
                    ...
                    <div>
                      ...
                      <p className="text-muted-foreground mb-3">Complete guide to working capital finance for SMEs—options, costs, and how to choose the right facility.</p>
              ...
              <a 
                href="/resources/guides/invoice-finance-australia-complete-guide"
                className="block p-4 border border-border rounded-lg hover:border-accent/40 hover:bg-accent/5 transition-all"
              >
                <h3 className="font-semibold text-foreground mb-2">Invoice Finance Guide</h3>
                <p className="text-sm text-muted-foreground mb-2">Unlock cash tied up in unpaid invoices through factoring and discounting.</p>
                <span className="text-accent text-sm inline-flex items-center">
                  Read Guide <ArrowRight className="ml-1 h-3 w-3" />
                </span>
              </a>
              <a 
                href="/resources/guides/debtor-finance-supply-chain-finance-australia"
                className="block p-4 border border-border rounded-lg hover:border-accent/40 hover:bg-accent/5 transition-all"
              >
                <h3 className="font-semibold text-foreground mb-2">Debtor & Supply Chain Finance</h3>
                <p className="text-sm text-muted-foreground mb-2">Comprehensive receivables and supply chain funding solutions.</p>
                <span className="text-accent text-sm inline-flex items-center">
                  Read Guide <ArrowRight className="ml-1 h-3 w-3" />
                </span>
              </a>
              ...
              >
                ...
                <p className="text-sm text-muted-foreground mb-2">Restructure multiple debts into manageable facilities.</p>
                <span className="text-accent text-sm inline-flex items-center">
                  Read Guide <ArrowRight className="ml-1 h-3 w-3" />
                </span>
              </a>
          ...
          <RelatedReading articles={[
            { title: "Working Capital Loans for SMEs", slug: "working-capital-loans-for-smes", description: "Understanding working capital options for small and medium businesses" },
            { title: "Invoice Finance Australia: Complete Guide", slug: "invoice-finance-australia-complete-guide", description: "How invoice financing can improve your business cash flow" }
          ] as RelatedArticle[]} />
