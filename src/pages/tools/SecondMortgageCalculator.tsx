              ...
              <Card>
                <CardContent className="p-6">
                  ...
                  <div className="space-y-3 text-foreground/80">
                    ...
                    <p>If your scenario is broader than simple equity access, it may also be worth comparing this tool with our <Link to="/resources/guides/second-mortgages-for-business-guide" className="text-primary hover:underline">second mortgage for business guide</Link>, the <Link to="/resources/guides/second-mortgages-for-business-guide" className="text-primary hover:underline">first and second mortgages guide</Link>, and the <Link to="/resources/guides/second-mortgage-lenders-australia-directory" className="text-primary hover:underline">second mortgage lenders directory</Link>.</p>
                  </div>
                </CardContent>
              </Card>
            </div>
