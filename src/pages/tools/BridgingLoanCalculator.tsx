      ...
      <div className="container mx-auto px-4 py-12">
        ...
        <div className="max-w-4xl mx-auto mb-16">
          <div className="text-center mb-8">
            <h1 className="text-4xl font-bold mb-4">Bridging Loan Calculator</h1>
              ...
              <div className="grid md:grid-cols-2 gap-8">
                ...
                <div className="space-y-4">
                  <div className="p-4 bg-muted rounded-lg">
                    ...
                    <p className="text-2xl font-bold">${Number(results.monthlyPayment).toLocaleString()}</p>
                  </div>
                  <div className="p-4 bg-muted rounded-lg">
                    <div className="flex items-center gap-2 mb-2">
                    ...
                    <p className="text-2xl font-bold">${Number(results.totalInterest).toLocaleString()}</p>
                  </div>
                  <div className="p-4 bg-muted rounded-lg">
                    <div className="flex items-center gap-2 mb-2">
                    ...
                    <p className="text-2xl font-bold">${Number(results.totalRepayment).toLocaleString()}</p>
                  </div>
                </div>
              </div>
            </CardContent>
        ...
        <article className="max-w-4xl mx-auto prose prose-lg">
          ...
          <h2>How to Use the Bridging Loan Calculator</h2>
          <p>
          ...
          <h3>Entering Your Loan Amount</h3>
          <p>
          ...
          <h3>Understanding Interest Rate Inputs</h3>
          <p>
          ...
          <h3>Setting Realistic Loan Terms</h3>
          <p>
          ...
          <h2>Understanding Your Calculator Results</h2>
          <p>
          ...
          <h3>Total Interest and Cost Projections</h3>
          <p>
          ...
          <h3>Effective Interest Rate Calculations</h3>
          <p>
          ...
          <h2>Comparing Bridging Loan Scenarios</h2>
          <p>
          ...
          <h3>Short-Term vs Extended Terms</h3>
          <p>
          ...
          <h3>Different Interest Rate Impacts</h3>
          <p>
          ...
          <h3>Loan Amount Optimisation</h3>
          <p>
          ...
          <h2>Beyond the Calculator: Hidden Costs</h2>
          <p>
          ...
          <h3>Establishment and Application Fees</h3>
          <p>
          ...
          <h3>Ongoing and Exit Expenses</h3>
          <p>
          ...
          <h3>Opportunity Costs and Alternatives</h3>
          <p>
          ...
          <h2>When Calculator Results Suggest Alternatives</h2>
          <p>
          ...
          <h3>Cost-Benefit Analysis Thresholds</h3>
          <p>
          ...
          <h3>How accurate is the bridging loan calculator?</h3>
          <p>
            The bridging loan calculator provides accurate estimates of interest costs and monthly payments based on the inputs you provide—loan amount, interest rate, and term. However, it shows interest-only calculations and doesn't include establishment fees (typically 1% to 3% of loan amount), legal costs ($2,000 to $5,000), valuation fees ($800 to $8,000), application fees ($1,000 to $2,500), or potential exit fees (0% to 2% of loan amount). Total costs typically run 15% to 25% higher than calculator interest figures alone. Use the calculator for initial estimates, then add these additional costs for comprehensive budget planning. The calculator assumes fixed interest rates—variable rate loans might cost more or less depending on rate movements during your loan term.
          </p>

          <h3>What interest rate should I enter in the calculator?</h3>
          <p>
            Enter the annual interest rate your lender quotes, typically ranging from 9% to 24% annually for bridging loans. If your lender quotes monthly rates (common for bridging finance), multiply by 12 to convert to annual: 1% monthly equals 12% annually, 1.5% monthly equals 18% annually. Your actual rate depends on property type, location, LVR, and credit profile. Prime residential property in capital cities typically attracts 12% to 15% annual rates, commercial property faces 15% to 18%, and higher-risk scenarios might reach 20% to 24%. Use the rate your lender indicates for your specific circumstances rather than advertised best-case rates. If comparing lenders, calculate scenarios at different rates to understand cost variations between options.
          </p>

          <h3>Can I reduce my monthly payments on bridging loans?</h3>
          <p>
            Bridging loan monthly payments reflect the interest-only structure—you're paying only interest monthly with principal due at loan maturity. The only ways to reduce monthly payments involve reducing the loan amount (contributing larger deposit), negotiating lower interest rates (shopping between lenders or improving your borrower profile), or choosing interest capitalisation where monthly interest adds to principal rather than requiring cash payment. Interest capitalisation reduces monthly cash outflow to zero but increases total debt—a $1 million loan with capitalised interest at 1.5% monthly grows to $1.196 million after 12 months. Some lenders allow partial capitalisation—paying 50% of monthly interest in cash whilst capitalising the other 50%—reducing monthly payments whilst limiting debt growth.
          </p>

          <h3>How do bridging loan costs compare to standard commercial loans?</h3>
          <p>
            Bridging loans cost significantly more than traditional commercial loans but provide much faster approval and funding. Commercial property loans typically charge 6% to 8% annually with 4 to 8 week approval timeframes, whilst bridging loans charge 12% to 24% annually but approve within days to two weeks. On a $1 million loan over 12 months, commercial lending costs approximately $70,000 interest, whilst bridging finance costs $120,000 to $240,000—roughly 70% to 240% more expensive. However, bridging loans don't require extensive serviceability assessment, accept properties banks decline, and enable time-sensitive opportunities traditional lending can't accommodate. The speed and flexibility premium justifies higher costs when urgency matters or conventional finance isn't available. Calculate both options when your timeline permits—sometimes accepting modest delays to secure cheaper funding dramatically improves project economics.
          </p>

          <h3>What loan term should I enter in the calculator?</h3>
          <p>
            Enter your realistic timeline until you can repay the bridging loan through property sale, refinancing, or other exit strategy—not the maximum term the lender offers. Typical bridging terms span 6 to 18 months. Underestimating creates artificially low cost projections that don't reflect reality. If you're purchasing a property and selling an existing one, estimate realistically how long your existing property will take to sell—for most markets, 3 to 6 months represents reasonable expectations. Add settlement time (typically 60 to 90 days) for your total term. If you're uncertain, calculate multiple scenarios: model 6 months (optimistic), 12 months (realistic), and 18 months (pessimistic) to understand cost ranges. Most bridging loans allow extensions beyond initial terms at slightly higher rates—factor this possibility into your planning rather than assuming everything proceeds perfectly on schedule.
          </p>
          ...
          <div className="mt-8 text-center">
            <Button asChild size="lg">
              <Link to="/contact">Get Your Personalised Quote</Link>
            </Button>
          </div>
        </article>
      </div>
