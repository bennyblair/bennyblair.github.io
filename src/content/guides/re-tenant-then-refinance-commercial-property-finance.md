---
title: "Commercial Property Re-Tenant Then Refinance Strategy"
description: "How commercial property owners can use a re-tenant then refinance strategy, including holding costs, lease evidence, lender assessment, risks and finance options."
date: "2026-06-10"
category: "Commercial Property Finance"
tags: ["Commercial Property Finance", "Refinance", "Private Lending", "Bridging Finance", "Investment Property"]
readingTime: 9
author: "Ben"
...
keywords: ["re-tenant then refinance", "commercial property refinance", "vacant commercial property finance", "commercial investment property finance"]
slug: "re-tenant-then-refinance-commercial-property-finance"
---
...
- **[Commercial Property Loan Serviceability](/resources/guides/commercial-property-loan-serviceability-how-much-can-you-borrow)** — How rental income and borrower cash flow affect loan capacity.

## At a Glance

| Question | Practical answer |
|---|---|
| What is the strategy? | Stabilise tenancy first, then refinance once rent, lease term and tenant evidence are stronger. |
| Who uses it? | Commercial property owners, investors and business borrowers with vacancy, weak lease evidence or a near-term refinance deadline. |
| Common finance need | Short-term holding finance, bridging finance, private lending or a refinance extension while leasing is completed. |
| Main lender focus | Current valuation, vacancy risk, lease campaign, exit strategy, borrower capacity and evidence of tenant demand. |
| Best fit | A fundamentally sound property with a fixable leasing issue and a realistic refinance pathway. |
| Main risk | The new tenant does not sign, the lease terms are weaker than expected, or the short-term debt runs longer than planned. |
...
For borrowers facing a hard maturity date, [commercial property loan covenant breach refinance options](/resources/guides/commercial-property-loan-covenant-breach-refinance-options) may also be relevant. If the timing issue is mainly settlement or refinance delay, [bridging finance](/resources/guides/bridging-finance-australia-complete-property-guide) may be the closer structure.
...
Serviceability still matters. The guide to [commercial property loan serviceability](/resources/guides/commercial-property-loan-serviceability-how-much-can-you-borrow) explains why lenders look beyond valuation and assess whether income can support the facility.
...
| Structure | When it may fit | Key risk |
|---|---|---|
| Bridging finance | A defined refinance or lease event is expected soon | Exit timing slips |
| Private lending | Bank criteria do not fit the temporary vacancy | Higher short-term cost |
| Second mortgage | Existing first mortgage stays in place while equity is accessed | Consent, priority and equity constraints |
| Caveat-backed finance | A very short business-purpose funding need exists | Limited term and title complexity |
| Refinance extension | Current lender allows time to complete leasing | Extension may be conditional or short |

For property-backed borrowers comparing lender types, [private lending in Australia](/resources/guides/what-is-private-lending-australia) and [private lending vs bank lending](/resources/guides/private-lending-vs-bank-lending-which-is-better) give useful context.
