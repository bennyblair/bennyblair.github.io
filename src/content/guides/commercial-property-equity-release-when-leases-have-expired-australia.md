---
title: "Commercial Property Equity Release When Leases Have Expired"
description: "How Australian business owners and investors can think about commercial property equity release when leases have expired, including lender concerns, refinance options, risks, and documents."
date: "2026-06-21"
category: "Commercial Property Finance"
slug: "commercial-property-equity-release-when-leases-have-expired-australia"
keywords:
  - "commercial property equity release lease expired Australia"
...
author_name: "Ben"
metaTitle: "Commercial Property Equity Release After Lease Expiry"
metaDescription: "Commercial property equity release after lease expiry explained for Australian business owners and investors. Learn lender concerns, refinance paths, documents, and risks."
---
...
|---|---|
| What is the issue? | The borrower wants to access equity while the commercial lease has expired or rental income is uncertain. |
| Who this is for | Commercial property owners, investors, developers, and business owners with equity in a vacant or short-income asset. |
| Main lender concern | Whether the property can be leased, sold, refinanced, or supported by other income if the vacancy continues. |
| Strongest evidence | Leasing campaign details, rental appraisal, valuation support, arrears-free conduct, exit plan, and borrower financials. |
| Common structures | Refinance, private lending, short-term bridging, second mortgage, or working-capital facility secured by property. |
| Main risk | Borrowing against stale valuation assumptions and then failing to lease, sell, or refinance on time. |
...
If the property still has a lease but the term is short, compare this guide with [commercial property finance for short-WALE assets](/resources/guides/commercial-property-finance-short-wale-assets-australia). If the property is fully vacant, the [vacant commercial property refinance guide](/resources/guides/vacant-commercial-property-refinance-in-australia-what-lenders-look-for) gives a more focused vacancy checklist.
...
A short-term bridging facility may fit when a sale campaign, refinance approval, or signed lease is already underway. Bridging should have a dated exit event, not just a hope that the market improves. For broader timing issues, compare [bridging finance in Australia](/resources/guides/bridging-finance-australia-complete-property-guide).

A second mortgage may be considered if the first mortgage remains in place and there is enough equity behind it. This is more complex because the second-ranking lender sits behind the first lender and may need consent or priority arrangements. The [second mortgage business guide](/resources/guides/second-mortgages-for-business-guide) explains this structure in more detail.
...
For business cash-flow needs, compare property-backed funding with [working capital loans for SMEs](/resources/guides/working-capital-loans-for-smes) and [business line of credit Australia](/resources/guides/business-line-of-credit-australia). Sometimes the property is not the only possible security or structure.
...
Borrowers comparing bank and private lender options should also read [private lending vs bank lending](/resources/guides/private-lending-vs-bank-lending-which-is-better). The right lender type depends on timing, security, documentation, and how much uncertainty the file carries.
