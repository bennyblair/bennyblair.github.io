---
title: "Second Mortgage Business Loan When Bank Consent Is Slow"
description: "A practical guide for Australian business borrowers dealing with slow bank consent for a second mortgage, including documents, fallback options, risks, and next steps."
date: "2026-08-18"
category: "Second Mortgages"
slug: "second-mortgage-business-loan-bank-consent-delay-australia"
keywords:
  - "second mortgage business loan when bank consent is slow Australia"
  - "second mortgage bank consent delay"
  - "business loan second mortgage consent"
  - "first mortgagee consent Australia"
readingTime: 10
author: "Daniel"
...
author_name: "Daniel"
metaTitle: "Second Mortgage Business Loan When Bank Consent Is Slow"
metaDescription: "Learn what to do when bank consent delays a second mortgage business loan in Australia. Documents, options and risks explained. General information only."
primaryQuery: "second mortgage business loan when bank consent is slow Australia"
...
- **[First Mortgagee Consent Delay: Caveat Loan vs Second Mortgage](/resources/guides/first-mortgagee-consent-delay-caveat-loan-vs-second-mortgage)** — a focused comparison of two possible structures when timing becomes critical.
- **[Priority Agreements in Second Mortgages](/resources/guides/priority-agreements-in-second-mortgages-what-they-mean)** — how ranking and enforcement arrangements can affect documentation.
...
## Why Can Bank Consent Take So Long?
...
## What To Do When Consent Is Slow
...
The [second mortgage lender document checklist](/resources/guides/second-mortgage-lender-document-checklist-from-broker-files) provides a deeper broker-side view of file preparation.

### 4. Work Backwards From the Real Deadline

Identify the date after which delay creates a material consequence, then test whether consent, legal and settlement steps can realistically fit. For property transactions, use the [commercial property settlement finance timeline](/resources/guides/commercial-property-settlement-process-finance-timeline).
...
For general background, read the [Caveat Loans Australia Complete Guide](/resources/guides/caveat-loans-australia-complete-guide). Where the timing gap relates to an incoming sale or refinance, [bridging finance in Australia](/resources/guides/bridging-finance-australia-complete-property-guide) may also be relevant, subject to lender and legal assessment.
...
### Does slow bank consent mean my second mortgage business loan has been declined?

No. Slow consent can mean the request is incomplete or waiting for credit, legal or priority review. Confirm the status in writing before treating it as a refusal.

### How long does first mortgagee consent take in Australia?

There is no universal timeframe. Timing depends on the first lender, its documents and workflow, the proposed second mortgage, the parties' lawyers and the completeness of the file. A broker or lawyer should not promise a consent date controlled by another institution.

### Can I register a second mortgage without telling the first bank?

Do not assume that you can. Existing facility and mortgage documents may require consent or restrict additional security, and the proposed second lender may insist on written consent or priority arrangements. Obtain independent legal advice on the specific documents and applicable state or territory law.

### Will a caveat loan bypass the bank consent requirement?

Not necessarily. Caveat finance is a different security structure, but it does not automatically override contractual restrictions or legal obligations. A lawyer should confirm whether the structure is permitted and whether a valid caveatable interest exists.

### What documents help reduce second mortgage consent delays?

A consistent pack commonly includes loan statements, title and ownership information, proposed terms, business-purpose evidence, entity documents, deadline evidence and a supported exit. The lender may request more.
...
- **[Second Mortgages for Business Guide](/resources/guides/second-mortgages-for-business-guide)** — core second mortgage concepts, uses and risks.
- **[First Mortgagee Consent Delay: Caveat Loan vs Second Mortgage](/resources/guides/first-mortgagee-consent-delay-caveat-loan-vs-second-mortgage)** — a detailed fallback comparison.
- **[Priority Agreements in Second Mortgages](/resources/guides/priority-agreements-in-second-mortgages-what-they-mean)** — priority terms and why they matter.
- **[How To Get a Business Loan in Australia](/resources/guides/how-to-get-a-business-loan-australia)** — broader business-purpose funding preparation.
- **[Caveat Loans Australia Complete Guide](/resources/guides/caveat-loans-australia-complete-guide)** — caveat finance fundamentals and legal risk points.
