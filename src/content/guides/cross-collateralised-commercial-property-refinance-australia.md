---
title: "Cross-Collateralised Commercial Property Refinance"
description: "Cross-collateralised commercial property refinance explained for Australian borrowers using multiple properties to restructure debt or release equity."
date: "2026-07-05"
category: "Commercial Property Finance"
slug: "cross-collateralised-commercial-property-refinance-australia"
keywords:
  - "cross collateralised commercial property refinance Australia"
  - "cross collateralised refinance"
  - "commercial property refinance multiple properties"
...
author_name: "Ben"
metaTitle: "Cross-Collateralised Commercial Property Refinance | Emet Capital"
metaDescription: "Guide to cross-collateralised commercial property refinance in Australia, including when multiple securities help, when they create risk, and what lenders assess."
---
...
- **[Second Mortgages for Business](/resources/guides/second-mortgages-for-business-guide)** — When a second-ranking facility may be compared.
- **[Commercial Property Valuation Dispute](/resources/guides/commercial-property-valuation-dispute-finance-options-australia)** — Options after a conservative valuation.

### At a Glance

| Question | Practical answer |
|---|---|
| **What is it?** | A refinance where multiple properties secure one facility or connected facilities. |
| **Who uses it?** | Business owners, investors, developers, and portfolio borrowers with equity spread across more than one asset. |
| **Best fit** | When no single property has enough usable equity or the borrower wants to restructure several debts together. |
| **Main lender focus** | Combined LVR, valuations, leases, title, existing debt, exit strategy, and borrower serviceability. |
| **Main risk** | One problem facility can place several secured assets under pressure. |
| **Alternatives** | Single-property refinance, second mortgage, bridging finance, private credit, staged discharge, or asset sale. |
...
It may be considered after a bank decline, a conservative valuation, a short lease, a maturity event, a covenant breach, or a need to release equity for business purposes. In those cases, compare the structure with [commercial property refinance after a bank decline](/resources/guides/commercial-property-refinance-after-a-bank-decline-in-australia), [commercial property loan covenant breach refinance](/resources/guides/commercial-property-loan-covenant-breach-refinance-options), and [private credit refinance](/resources/guides/private-credit-refinance-commercial-property-australia).
...
Borrower strength also matters. Lenders may review business financials, bank statements, rent rolls, facility statements, ATO position, business purpose, and the reason for refinance. For documentation planning, see [business loan requirements](/resources/guides/business-loan-requirements-australia-commercial-borrowers) and [commercial property due diligence](/resources/guides/commercial-property-due-diligence-finance-checklist).
...
A third benefit is consolidation. Some borrowers use a portfolio refinance to simplify several debts, replace short-term facilities, or prepare for a staged sale and refinance plan. Where timing pressure is high, compare [commercial bridging finance](/resources/guides/when-commercial-bridging-finance-makes-sense-in-australia-and-when-it-does-not) and [bridging loan exit strategies](/resources/guides/bridging-loan-exit-strategies-plan-your-repayment-path).
...
Before cross-collateralising a portfolio, compare the cleanest available structure. A single-property refinance may be simpler. A [second mortgage](/resources/guides/what-is-a-second-mortgage) may preserve the first facility if first mortgagee consent is available and the risk fits. A [caveat loan](/resources/guides/caveat-loans-australia-complete-guide) may suit very short-term business-purpose funding where legally appropriate and exit is clear.
...
For development or settlement timing, [bridge lending for commercial property](/resources/guides/bridge-lending-australia-commercial-property) may be more relevant than a portfolio refinance. For a property with a valuation issue, read [commercial property valuation dispute finance options](/resources/guides/commercial-property-valuation-dispute-finance-options-australia).
...
- **[Commercial Property Finance Short-WALE Assets](/resources/guides/commercial-property-finance-short-wale-assets-australia)**
- **[Vacant Commercial Property Refinance](/resources/guides/vacant-commercial-property-refinance-in-australia-what-lenders-look-for)**
...
- **[Private Credit Broker vs Direct Fund](/resources/guides/private-credit-broker-vs-direct-private-credit-fund-australia)**
