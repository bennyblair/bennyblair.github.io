---
title: "Second Mortgages for Business in Australia: Complete Guide"
...
- **[Caveat Loan vs Second Mortgage](/resources/guides/caveat-loan-vs-second-mortgage-which-is-right-for-you)** — understand how urgent secured funding differs from a planned second mortgage.
- **[Caveat Loan Exit Strategies](/resources/guides/caveat-loan-exit-strategies-how-to-repay-or-refinance)** — plan repayment before taking short-term secured debt.
- **[Business Acquisition Finance Australia](/resources/guides/business-acquisition-finance-australia)** — relevant where equity release supports a buyout or acquisition.
- **[Business Debt Consolidation Australia](/resources/guides/business-debt-consolidation-australia)** — relevant where the second mortgage is part of a debt restructure.
...
| Use case | Why a second mortgage may be considered | What needs to be proven |
|---|---|---|
| Partner or shareholder buyout | Raises defined capital without replacing the first mortgage | Signed buyout terms, valuation support, transition plan, serviceability after the exit |
| Expansion or equipment | Funds a specific growth event where timing matters | Return on funds, implementation budget, fallback if revenue lags |
| Debt restructure | Consolidates expensive short-term debts into one secured facility | Root cause fixed, cash-flow improvement, no repeat reliance on short-term debt |
| Settlement or refinance gap | Covers timing between a deadline and longer-term finance | Contract dates, refinance path, valuation support, backup exit |
| Working-capital injection | Provides one-off liquidity against equity | Temporary need, repayment source, and evidence it is not masking structural losses |
  ...
  "mainEntity": [
    {
      ...
      "acceptedAnswer": {
        "@type": "Answer",
        "text": "Second mortgages make most sense when preserving favourable first mortgage terms. If your existing first mortgage carries low fixed rates (a lender-specific range) with years remaining, refinancing to higher current rates costs more than adding second mortgage. Calculate both scenarios: total annual cost of maintaining first mortgage plus adding second mortgage versus refinancing everything."
      }
    },
    {
      "@type": "Question",
      ...
      "acceptedAnswer": {
        "@type": "Answer",
        "text": "Business second mortgages typically cost a lender-specific range annually depending on property equity, business strength, and lender type. Strong businesses with substantial property equity secure a lender-specific range, whilst weaker profiles face a lender-specific range. This represents a lender-specific range premium over first mortgage rates."
      }
    },
    {
      "@type": "Question",
      ...
      "acceptedAnswer": {
        "@type": "Answer",
        "text": "Second mortgage borrowing depends on property equity and combined LVR. Most lenders cap combined LVR at a lender-specific range. If your property values at an indicative amount with an indicative amount first mortgage, you could potentially borrow an indicative amount to an indicative amount second mortgage. Cash flow serviceability also limits borrowing."
      }
    },
    {
      "@type": "Question",
