...
keywords:
  - "second mortgage consent refused Australia"
  - "first mortgagee consent refused"
...
- **[Second Mortgages for Business Guide](/resources/guides/second-mortgages-for-business-guide)** — how second mortgages work for commercial borrowers.
...
|---|---|
| What happened? | The first lender declined consent for a second mortgage behind its loan. |
| Does that mean no funding? | Not always, but the structure usually needs to change. |
| Common alternatives | Refinance, different security, caveat-style short-term finance, equity contribution, or revised facility size. |
| Main lender focus | Equity, first mortgage terms, purpose, conduct, exit, and legal priority. |
| Main risk | Trying to force a structure that the first mortgagee or second lender cannot accept. |
| Best next step | Identify why consent was refused before choosing an alternative. |
...
The [second mortgage lender document checklist](/resources/guides/second-mortgage-lender-document-checklist-from-broker-files) is useful because the second lender’s questions often overlap with what the first mortgagee wants to understand before deciding whether consent is acceptable.
...
A full refinance may be cleaner if the property has enough value and the borrower can move the whole debt to one lender. If the timing is urgent, [bridging finance](/resources/guides/bridging-finance-australia-complete-property-guide) or another short-term commercial structure may be considered, but only where the exit is clear.
...
In limited urgent commercial scenarios, a [caveat loan](/resources/guides/caveat-loans-australia-complete-guide) or [caveat loan for settlement](/resources/guides/caveat-loans-for-property-settlement-bridge-your-purchase) may be discussed. Legal advice is important because caveats, mortgages, and consent rights are different security concepts.
...
For borrowers comparing bank and private options, the [private lending vs bank lending guide](/resources/guides/private-lending-vs-bank-lending-which-is-better) explains why specialist lenders may assess timing, security, and exit differently from mainstream banks.
