---
title: "Second Mortgage Lender Document Checklist From Broker Files"
description: "A broker-style second mortgage document checklist for Australian business borrowers, covering security, first mortgage evidence, purpose, serviceability, and exit documents."
date: "2026-05-31"
category: "Second Mortgages"
slug: "second-mortgage-lender-document-checklist-from-broker-files"
keywords:
  - "second mortgage lender document checklist from broker files"
  - "second mortgage documents"
  - "second mortgage checklist Australia"
  - "business second mortgage documents"
readTime: "9 min read"
author: "Ben"
...
- **[Second Mortgages for Business](/resources/guides/second-mortgages-for-business-guide)** — the main pillar guide for Australian business second mortgages.
- **[Second Mortgage Equity Access Strategies](/resources/guides/second-mortgage-loan-equity-access-strategies)** — compare common equity-release use cases.
- **[Second Mortgage Without Refinancing](/resources/guides/second-mortgage-without-refinancing-your-first-mortgage-in-australia)** — useful when the goal is to preserve the first mortgage.
- **[Caveat Loan vs Second Mortgage](/resources/guides/caveat-loan-vs-second-mortgage-which-is-right-for-you)** — compare urgent caveat finance with a registered second mortgage.
...
- **[Private Lending vs Bank Lending](/resources/guides/private-lending-vs-bank-lending-which-is-better)** — compare assessment style and timing across lender types.

## At a Glance

| Checklist area | What the lender is trying to confirm |
|---|---|
| Identity and entity | Who is borrowing, who owns the property, and who controls the business. |
| Security | Property value, title, existing mortgage, available equity, and priority position. |
| First mortgage | Current lender, balance, repayment conduct, consent position, and restrictions. |
| Purpose | Why the funds are needed and whether the use is commercial. |
| Serviceability | Whether the business can carry the combined debt during the loan term. |
| Exit | How the second mortgage will be repaid, refinanced, or cleared. |
| Legal readiness | Whether parties can sign, obtain advice, and settle without avoidable delays. |
...
This checklist is most useful where the borrower is using property equity for working capital, debt restructure, equipment, acquisition funding, settlement support, or a short-term commercial opportunity. For broad suitability analysis, start with [second mortgages for business](/resources/guides/second-mortgages-for-business-guide) before assembling documents.
...
|---|---|
| Borrower and guarantor ID | Confirms identity and signing parties. |
| Company and trust documents | Shows the correct borrower, trustee, directors, and authority to borrow. |
| Property title or address details | Confirms ownership, security type, and title interests. |
| First mortgage statement | Shows the current lender, balance, repayment conduct, and facility type. |
| Council rates or land tax notice | Helps verify ownership and property details. |
| Recent valuation or sales evidence | Supports the equity position before formal valuation. |
| Loan purpose summary | Explains what the funds will be used for. |
| Exit strategy evidence | Shows how the loan will be repaid or refinanced. |

Where the property is commercial, lenders may also ask for leases, rent schedules, outgoings, zoning information, and insurance evidence. The [commercial property loans guide](/resources/guides/commercial-property-loans-australia-complete-guide) explains how these documents affect lender assessment.
...
Some borrowers choose a second mortgage because they do not want to disturb a favourable first mortgage. If that is the reason, read [second mortgage without refinancing](/resources/guides/second-mortgage-without-refinancing-your-first-mortgage-in-australia) and make the preservation rationale clear in the file.
...
For borrowers choosing between a caveat and a second mortgage, [caveat loan vs second mortgage](/resources/guides/caveat-loan-vs-second-mortgage-which-is-right-for-you) explains why registration type, speed, priority, and lender appetite can change the document list.
...
If the purpose is debt restructure, compare the file with [business debt consolidation](/resources/guides/business-debt-consolidation-australia). If the purpose is acquisition, review [business acquisition finance](/resources/guides/business-acquisition-finance-australia) so goodwill, transition, and working-capital evidence are not missed.
...
If the loan is primarily for short-term working capital, [working capital loans for SMEs](/resources/guides/working-capital-loans-for-smes) can help frame the difference between temporary cash-flow pressure and a permanent funding gap.
...
| Exit path | Evidence that helps |
|---|---|
| Refinance | Indicative refinance capacity, improved financials, accountant notes, or broker refinance plan. |
| Property sale | Agency agreement, contract status, valuation, or sale timeline. |
| Business cash event | Debtor ledger, confirmed contract, staged payment evidence, or forecast. |
| Asset sale | Sale agreement, appraisal, or buyer correspondence. |
| Debt restructure | Payout letters, consolidation plan, and cash-flow improvement evidence. |

A clean exit plan does not guarantee approval, but it helps lenders assess whether the second mortgage is transitional or likely to become a problem. For broader non-bank comparisons, see [private lending vs bank lending](/resources/guides/private-lending-vs-bank-lending-which-is-better).
...
1. Who is the borrower, property owner, and guarantor?
2. What property is being offered as security?
3. Who holds the first mortgage and what is the current balance?
4. Does the first mortgage allow or require consent for a second mortgage?
5. What is the commercial purpose of the funds?
6. What documents prove the amount required?
7. How will the business service the facility?
8. What is the exit strategy?
9. What could delay legal signing or settlement?
10. Have relevant directors obtained appropriate professional advice?
