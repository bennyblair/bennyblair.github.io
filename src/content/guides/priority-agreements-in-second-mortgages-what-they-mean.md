---
title: "Priority Agreements in Second Mortgages: What They Mean for Commercial Borrowers"
description: "A practical guide to priority agreements in second mortgages, including why they matter, when lenders ask for them, and how they affect commercial borrowers using layered property-backed debt. Informational only."
date: "2026-04-07"
category: "Property Finance"
slug: "priority-agreements-in-second-mortgages-what-they-mean"
keywords:
  - "priority agreement second mortgage"
  - "second mortgage priority agreement"
  - "intercreditor agreement second mortgage"
...
| Question | Answer |
|---|---|
| What is it? | A lender-to-lender agreement that sets the practical rules between first and second mortgage holders. |
| Who is it for? | Commercial borrowers using a second mortgage behind existing property debt. |
| When is it useful? | When layered debt creates questions about ranking, enforcement, information, or repayment waterfalls. |
| When is it not enough? | When the deal documents, title issues, or security package are unclear and need separate legal work. |
...
Borrowers often focus only on the facility amount, but the real commercial issue is whether the layered structure still leaves enough room for a workable exit. That is one reason **[commercial property valuation for finance](/resources/guides/commercial-property-valuation-for-finance-lender-requirements)** and **[commercial property lvr explained](/resources/guides/commercial-property-lvr-explained-maximise-your-borrowing)** matter so much in second-mortgage files.
...
That is especially relevant in files involving **[business debt consolidation](/resources/guides/business-debt-consolidation-australia)**, **[ATO tax debt finance](/resources/guides/ato-tax-debt-finance-for-australian-business-owners)**, or a short-term bridge before a broader restructure. In those scenarios, the borrower is not just taking debt. They are managing timing risk.
...
A borrower owns a commercial property worth $3.6 million with a first mortgage balance of $1.95 million. They need additional capital for a time-sensitive business acquisition and obtain a second mortgage for $550,000.
