---
title: "Commercial Property Loan Covenants: What Happens When a Business Breaches Them?"
description: "Plain-English guide to commercial property loan covenant breaches in Australia, including what lenders monitor, what happens after a breach, and when refinance or private lending may create time to repair. General information only - not advice."
date: "2026-04-28"
category: "Commercial Property Finance"
slug: "commercial-property-loan-covenants-what-happens-when-a-business-breaches-them"
keywords:
  - "commercial loan covenant breach finance australia"
  - "commercial property loan covenants"
  - "loan covenant breach Australia"
...
- **[Bank vs Non-Bank Commercial Lending](/resources/guides/bank-vs-non-bank-commercial-lending-in-australia-which-borrowers-get-approved)** — How lender appetite differs when files become complex.
- **[Private Credit for SME Borrowers](/resources/guides/private-credit-for-sme-borrowers-in-australia-when-it-replaces-bank-finance)** — When non-bank capital may replace bank finance for a commercial borrower.
- **[Commercial Property Loan Serviceability](/resources/guides/commercial-property-loan-serviceability-how-much-can-you-borrow)** — How lenders assess cash flow and repayment capacity.
- **[Second Mortgages for Business](/resources/guides/second-mortgages-for-business-guide)** — How existing property equity may support short-term business funding.

## At a Glance

| Question | Practical answer |
|---|---|
| **What is a covenant?** | A condition in a commercial loan that the borrower must keep meeting after settlement. |
| **What is a breach?** | A failure to meet a condition, such as LVR, reporting, interest cover, or property-income requirements. |
| **Does breach mean default?** | It can be an event of default, but lenders may waive, vary, monitor, or require an exit rather than enforce immediately. |
| **What matters most?** | Cause of breach, property value, borrower conduct, reporting quality, arrears position, security, and refinance plan. |
| **Can refinance help?** | Sometimes, especially if there is enough equity, a credible exit, and the issue is timing or policy rather than permanent insolvency. |
| **What should borrowers avoid?** | Silence, late reporting, unpaid statutory debt, optimistic valuations, and refinancing without a realistic repayment path. |
...
For valuation-specific issues, the [commercial property valuation for finance](/resources/guides/commercial-property-valuation-for-finance-lender-requirements) guide explains why lender valuations may differ from owner expectations.
...
A vacant property, short lease, tenant dispute, or rent reduction can create covenant pressure. If this is your situation, [vacant commercial property refinance](/resources/guides/vacant-commercial-property-refinance-in-australia-what-lenders-look-for) and [refinancing commercial property with a short lease remaining](/resources/guides/refinancing-commercial-property-with-a-short-lease-remaining) are useful adjacent guides.
...
Where tax pressure is part of the covenant problem, compare the issue with [ATO tax debt finance](/resources/guides/ato-tax-debt-finance-for-australian-business-owners), [ATO garnishee notice finance](/resources/guides/ato-garnishee-notice-finance-for-australian-businesses), and [Director Penalty Notice finance](/resources/guides/director-penalty-notice-finance-in-australia-funding-options-before-the-21-day-deadline).
...
This is where [private lending in Australia](/resources/guides/what-is-private-lending-australia), [private credit for SME borrowers](/resources/guides/private-credit-for-sme-borrowers-in-australia-when-it-replaces-bank-finance), and [bank vs non-bank commercial lending](/resources/guides/bank-vs-non-bank-commercial-lending-in-australia-which-borrowers-get-approved) become relevant. The lender is still assessing risk, but the assessment may focus more heavily on security, exit, and transaction logic than a bank policy matrix.
...
If the issue is a property purchase or settlement deadline, the [commercial property settlement process](/resources/guides/commercial-property-settlement-process-finance-timeline) guide can help frame timing. If the problem is debt stack complexity, [commercial loan rates](/resources/guides/commercial-loan-rates-banks-vs-private-lenders-compared) and [commercial property lenders](/resources/guides/commercial-property-lenders-in-australia-complete-directory) explain lender comparison factors beyond headline price.
...
- **[Commercial Property Loan Deposits](/resources/guides/commercial-property-loan-deposits-how-much-do-you-need)** — How equity contribution affects lender risk.
- **[Guarantor Requirements for Commercial Property Loans](/resources/guides/guarantor-requirements-for-commercial-property-loans)** — What directors and guarantors should understand before restructuring debt.
- **[Commercial Property LVR Explained](/resources/guides/commercial-property-lvr-explained-maximise-your-borrowing)** — How loan-to-value ratios affect commercial borrowing capacity.
- **[Business Debt Consolidation](/resources/guides/business-debt-consolidation-australia)** — When consolidating business debt may simplify repayment pressure.
- **[Commercial Bridging Finance](/resources/guides/when-commercial-bridging-finance-makes-sense-in-australia-and-when-it-does-not)** — When short-term property-backed funding may be appropriate.
